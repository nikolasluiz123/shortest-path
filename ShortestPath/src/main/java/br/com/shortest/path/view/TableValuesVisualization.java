...
public class TableValuesVisualization extends Application {
	...
	public void start(Stage stage) {
		try {
			if (file == null) {
				AlertUtils.showErrorDialog("Utilize o atalho Control + I para importar um arquivo txt com as distâncias, dessa forma você poderá visualizar os dados na tela.");
			} else {
